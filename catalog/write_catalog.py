...
#         chapter_codes.sort(key=lambda code: get_numeric_stamp(code, 'chapter'))
...
#         collection_codes.sort(key=lambda code: get_numeric_stamp(code, 'collection'))
...
#         section_codes.sort(key=lambda code: get_numeric_stamp(code, 'section'))
...
#         subsection_codes.sort(key=lambda code: get_numeric_stamp(code, 'subsection'))
